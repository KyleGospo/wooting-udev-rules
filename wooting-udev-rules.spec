...
SUBSYSTEM=="usb", ATTRS{idVendor}=="31e3", ATTRS{idProduct}=="1100", RUN+="/usr/sbin/modprobe xpad", MODE:="0660", GROUP="input"
...
SUBSYSTEM=="usb", ATTRS{idVendor}=="31e3", ATTRS{idProduct}=="1210", RUN+="/usr/sbin/modprobe xpad", MODE:="0660", GROUP="input"
...
SUBSYSTEM=="usb", ATTRS{idVendor}=="31e3", ATTRS{idProduct}=="1220", RUN+="/usr/sbin/modprobe xpad", MODE:="0660", GROUP="input"
